									...
									<tr>
										<td class='small' width='300'>
											<table class='small' >
												<tr>
													<td>
														<img src='images/mmo.png' name='img1' onClick="minTen(<?php  echo $inv['munp'.$i];?>)"  onMouseOver="img1.src='images/mmi.png'"   onMouseOut="img1.src='images/mmo.png'">
													</td>
													<td>
														<img src='images/mo.png' name='img2' onClick="minOne(<?php  echo $inv['munp'.$i];?>)"  onMouseOver="img2.src='images/mi.png'"   onMouseOut="img2.src='images/mo.png'">
													</td>
													<td align=center width='100%'>
															<!--<div id='plus'><font color="00FF00">+ 0</font></div>-->	<div id='action'><?php  echo $inv['munp'.$i];?> | <?php  echo $arm['munmax'];?></div> 
													</td>
													<td align=right>
														<img src='images/po.png' name='img3' onClick="plusOne(<?php  echo $inv['munp'.$i];?>,<?php  echo $arm['munmax'];?>)"  onMouseOver="img3.src='images/pi.png'"   onMouseOut="img3.src='images/po.png'" >
													</td>
													<td align=right>
														<img src='images/ppo.png' name='img4' onClick="plusTen(<?php  echo $inv['munp'.$i];?>,<?php  echo $arm['munmax'];?>)"   onMouseOver="img4.src='images/ppi.png'"   onMouseOut="img4.src='images/ppo.png'">
													</td>
												</tr>
											</table>
										</td>
