...
<table width='100%' class='small'>
	...
	<tr>
		...
		<td width='30%' class='title2'><a href="index.php?page=perso&onglet=levelup&perso=<?php echo $perso->getId();?>&stat=0"><img src="pic/plus.png"/></a></td>
	</tr>
	<tr>
		<td width='50%' align=right class='title2'>Dextérité :</td>
		<td width='20%' align=center><?php echo $perso->getDexterite();?></td>
		<td width='30%' class='title2'><a href="index.php?page=perso&onglet=levelup&perso=<?php echo $perso->getId();?>&stat=1"><img src="pic/plus.png"/></a></td>
	</tr>
	<tr>
		<td	width='50%' align=right class='title2'>Esquive :</td>
		<td width='20%' align=center><?php echo $perso->getEsquive();?></td>
		<td width='30%' class='title2'><a href="index.php?page=perso&onglet=levelup&perso=<?php echo $perso->getId();?>&stat=2"><img src="pic/plus.png"/></a></td>
	</tr>
</table>
