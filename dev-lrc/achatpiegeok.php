<?php
	...
	$sql = 'SELECT argent,vie,id FROM perso WHERE perso.id_membre = "'.$_SESSION['login'].'" and perso.nom = "'.$nom.'"'; //on sélèctionne l'argent, arme, pige, vie du perso du membre connecté
