						...
						<td colspan=3 bgcolor='333333'>
								...
								<table class='button' width='100%'  >
									<tr>
										...
										<td align=center class='color3'><a href='ajoutpt.php?perso=<?php echo $perso->getId();?>&i=<?php echo $i;?>&type=deg'><img src="pic/plus.png" width='20px' height='20px'/></a></td>
									</tr>
									<tr>
										<td class='color4'>PRECISION</td><td class='small' width=60 align=right><font color="00ff00" > + <?php echo $inv['prec'.$i]*10;?>%</font></td>
										<td align=center  class='color4'><a href='ajoutpt.php?perso=<?php echo $perso->getId();?>&i=<?php echo $i;?>&type=pre'><img src="pic/plus.png" width='20px' height='20px'/></a></td>
									</tr>
									<tr>
										...
										<td align=center class='color3'><a href='ajoutpt.php?perso=<?php echo $perso->getId();?>&i=<?php echo $i;?>&type=cap'><img src="pic/plus.png" width='20px' height='20px'/></a></td>
								<!--	<tr>
								...
								<table class='title2' width='100%'>
									...
									<tr align=center class='small'>
										<td>
											<font color="00ff00" size=3 ><? echo $inv['ptamelio'];?></font>
										</td>
									</tr>
								</table>
						</td>
