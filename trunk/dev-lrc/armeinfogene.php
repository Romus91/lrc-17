			...
			<table class='button' width='100%'  >
				<tr>
					...
					<td align=center class='color3'><a href='ajoutpt.php?perso=<?php echo $perso->getId();?>&i=<?php echo $i;?>&type=deg'><img src="image.php?img=plus.png&w=20&h=20"/></a></td>
				</tr>
				<tr>
					<td class='color4'>PRECISION</td><td class='small' width=60 align=right><font color="00ff00" > + <?php echo $inv['prec'.$i]*10;?>%</font></td>
					<td align=center  class='color4'><a href='ajoutpt.php?perso=<?php echo $perso->getId();?>&i=<?php echo $i;?>&type=pre'><img src="image.php?img=plus.png&w=20&h=20"/></a></td>
				</tr>
				<tr>
					...
					<td align=center class='color3'><a href='ajoutpt.php?perso=<?php echo $perso->getId();?>&i=<?php echo $i;?>&type=cap'><img src="image.php?img=plus.png&w=20&h=20"/></a></td>
			<!--	<tr>
