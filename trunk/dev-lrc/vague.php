...
?>
	...
	<table class='small ' width='550'>
		...
		<tr>
			...
			<td align=center class='color2'><font size=4><?php  echo $crabe;?> </font>
			</td>
			<td align=center class='color2'><font size=4><?php  echo $zombie;?> </font>
			</td>
			<td align=center class='color2'><font size=4><?php  echo $zombiefast;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombiepoison;?>
			</font></td>
		</tr>
		<tr>
			<td align=right class='title2'><b>KILL</b></td>
			<td align=center class='color2'><font size=4><?php  echo $crabekill;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombiekill;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombiefastkill;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombiekillpois;?>
			</font></td>
		</tr>
		<tr>
			<td align=right class='title2'><b>SURVIVOR</b></td>
			<td align=center class='color2'><font size=4><?php  echo $crabenb;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombienb;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombiefastnb;?>
			</font></td>
			<td align=center class='color2'><font size=4><?php  echo $zombiepoisonnb;?>
			</font></td>
		</tr>
		<tr>
				...
				<table width='100%' class='title2'>
					<tr>
						<td align=center class='title2' valign=top>
							<table class='small' width='105'>
								<tr>
									<td align=center><font color='00FF00'>+ <?php  echo $gagne;?> </font>
									</td>
								</tr>
							</table>
							<table class='hev'>
								<tr>
									<td align=center><font size=5><?php  echo $perso->getArgent();?>$</font>
									</td>
								</tr>
							</table>
						</td>
						<td class='title2' align=center>
							...
							<table class='hev'>
								<tr>
									<td align=center><font size=5><b>EXP</b> </font><br> <font
										color=FFFF00 size=3><?php  echo $perso->getXp();?> </font>
									</td>
								</tr>
								<tr>
									<td align=left>
										<table class='button'>
											<tr height='10' valign=bottom>
												...
												?> <img src='pic/viergej.png' width='<?php echo $pourc;?>%'
													height='10'>
												</td>
											</tr>
										</table>
						...
						<td class='title2' valign=bottom align=center>
							...
							<table class='hev'>
								<tr>
									<td align=center><font size=5><b>NRG</b> </font>
									</td>
								</tr>
								<tr>
									<td align=left>
		...
		<tr>
			<td colspan='5' align=center><img src='pic/finvague.JPG' width='540'>
			</td>
		</tr>
	</table>
</center>
